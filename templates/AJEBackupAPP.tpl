...
#!===========================================================================
 #TAB('About')
   #DISPLAY('')
   #IMAGE('AJEico_about.png'),AT(,,12,12)
   #DISPLAY('Welcome'),AT(,,260,14),PROP(PROP:FontColor,0794E1FH),PROP(PROP:FontStyle,700),PROP(PROP:FontSize,10),PROP(PROP:Font,'Segoe UI')
  ...
  #TAB('Configuration')
    #DISPLAY('')
    #IMAGE('AJEico_config.png'),AT(,,12,12)
    #DISPLAY('Configuration'),AT(,,260,14),PROP(PROP:FontColor,0794E1FH),PROP(PROP:FontStyle,700),PROP(PROP:FontSize,10),PROP(PROP:Font,'Segoe UI')
  ...
  #TAB('Other Files')
    #DISPLAY('')
    #IMAGE('AJEico_files.png'),AT(,,12,12)
    #DISPLAY('Other Files'),AT(,,260,14),PROP(PROP:FontColor,0794E1FH),PROP(PROP:FontStyle,700),PROP(PROP:FontSize,10),PROP(PROP:Font,'Segoe UI')
  ...
  #TAB('Settings')
    #DISPLAY('')
    #IMAGE('AJEico_settings.png'),AT(,,12,12)
    #DISPLAY('Settings'),AT(,,260,14),PROP(PROP:FontColor,0794E1FH),PROP(PROP:FontStyle,700),PROP(PROP:FontSize,10),PROP(PROP:Font,'Segoe UI')
  ...
  #TAB('License')
    #DISPLAY('')
    #IMAGE('AJEico_license.png'),AT(,,12,12)
    #DISPLAY('License'),AT(,,260,14),PROP(PROP:FontColor,0794E1FH),PROP(PROP:FontStyle,700),PROP(PROP:FontSize,10),PROP(PROP:Font,'Segoe UI')
  ...
  #TAB('Instructions')
    #DISPLAY('')
    #IMAGE('AJEico_help.png'),AT(,,12,12)
